...
if (isset($_POST['save_gov_id'])) {
  ...
  if ($action === 'delete') {
    ...
    if ($gov_id == '') {
      mysqli_query($conn, "INSERT INTO EmployeeGovernmentIDs (employee_id, sss_number, philhealth_number, pagibig_number, tin_number)
                VALUES ('$employee_id', '$sss', '$philhealth', '$pagibig', '$tin')");
      $_SESSION['toast'] = 'Government ID added!';
    } else {
      $id = mysqli_real_escape_string($conn, $gov_id);
      mysqli_query($conn, "UPDATE EmployeeGovernmentIDs SET 
                sss_number='$sss',
...
<script>
  ...
  // JS function to manually populate (optional call)
  function populateGovIDForm(data) {
    document.getElementById('gov_id').value = data.id;
    ...
    document.getElementById('govFormTitle').innerText = "Edit Government ID";
  }
  ...
  function clearGovIDForm() {
    ...
    document.getElementById('govFormTitle').innerText = "Add Government ID";
  }
</script>
<script>
  $(document).ready(function () {
