...
if (isset($_POST['add_missing_request'])) {
    ...
    $insert = mysqli_query($conn, "INSERT INTO missingtimelogrequests 
        ...
        VALUES ($employee_id, '$date', '$missing_field', '$requested_time', '$reason')");
  ...
  <div class="modal-dialog">
    <form method="POST" class="modal-content">
      ...
      <div class="modal-footer">
        <button type="submit" name="add_missing_request" class="btn btn-primary"><i class="ti ti-check me-1"></i>Submit</button>
      </div>
    </form>
  </div>
</div>
  ...
  <div class="modal-dialog">
    <form method="POST" class="modal-content">
      <div class="modal-header bg-warning text-white">
        <h5 class="modal-title"><i class="ti ti-edit me-2"></i>Update Status</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>
      <div class="modal-body">
        ...
        <div class="mb-3">
          ...
          <textarea name="approval_remarks" class="form-control" rows="3" placeholder="Enter remarks"></textarea>
        </div>
      </div>
      <div class="modal-footer">
...
$(document).ready(function () {
  $('#missingTable').DataTable({
    ...
    language: {
      ...
      search: '',
      searchPlaceholder: 'Search missinglogs requests...',
  ...
  $('.viewBtn').click(function () {
    ...
    $('#view_requested_time').text($(this).data('requested_time'));
  ...
  Swal.fire({ icon: 'success', title: 'Success', text: '<?= $_SESSION['success']; ?>', timer: 3000, toast: true, position: 'top-end', showConfirmButton: false });
  <?php unset($_SESSION['success']); endif; ?>

  <?php if (isset($_SESSION['error'])): ?>
  Swal.fire({ icon: 'error', title: 'Error', text: '<?= $_SESSION['error']; ?>', timer: 3000, toast: true, position: 'top-end', showConfirmButton: false });
