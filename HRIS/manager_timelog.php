...
// Get manager details once at the start
    ...
    <tbody>
      <?php while ($row = $result->fetch_assoc()): ?>
        <tr>
          ...
          <td>
            <button type="button" class="btn btn-sm btn-primary btn-edit-timelog"
              data-request='<?= json_encode($row) ?>'>
              <i class="bi bi-pencil-square"></i>
            </button>
            <button type="button" 
        class="btn btn-sm btn-danger btn-delete-timelog"
