...
<nav class="pc-sidebar">
  <div class="navbar-wrapper">
    ...
    <div class="sidebar-user text-center p-3" 
     style="position: relative; background: url('https://static.vecteezy.com/system/resources/thumbnails/006/691/202/small/abstract-background-with-soft-gradient-color-and-dynamic-shadow-on-background-background-for-wallpaper-eps-10-free-vector.jpg') no-repeat center center; background-size: cover; color: white;">
      ...
      <div style="position: relative; z-index: 1;">
        <img src="<?= !empty($profile['photo_path']) ? htmlspecialchars($profile['photo_path']) : 'assets/images/default-user.jpg'; ?>"
             ...
             style="width: 60px; height: 60px; object-fit: cover; border: 2px solid #fff; background: #fff;">
