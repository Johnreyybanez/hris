...
/* Dark mode background logo - maintain opacity */
body.dark-mode .bg-logo {
    opacity: 0.20;  /* Keep same opacity as light mode */
    filter: invert(1) brightness(0.9);  /* Just invert colors for dark mode */
}
...
@media (max-width: 1200px) {
  .bg-logo {
    ...
    body.dark-mode .loader-bg img {
      filter: invert(1) brightness(0.8); /* Invert colors and adjust brightness for dark mode */
    }
...
body.dark-mode .dropdown-notification .text-muted {
...
body.dark-mode .dropdown-notification .btn-primary {
    background-color: #0d6efd;
    border-color: #0d6efd;
    color: #fff;
}

body.dark-mode .dropdown-notification .btn-secondary {
    background-color: #2d2d2d;
    border-color: #444;
    color: #e0e0e0;
}

body.dark-mode .dropdown-notification .badge {
    background-color: #dc3545;
    color: #fff;
}

/* Dark mode styles for card footer */
...
body.dark-mode .card-footer .btn-outline-secondary {
    color: #e0e0e0;
    border-color: #555;
}

body.dark-mode .card-footer .btn-outline-secondary:hover {
    background-color: #333;
    border-color: #666;
}

body.dark-mode .card-footer .btn-outline-info {
    color: #5bc0de;
    border-color: #5bc0de;
}

body.dark-mode .card-footer .btn-outline-info:hover {
    background-color: #5bc0de;
    color: #1e1e1e;
}

body.dark-mode .card-footer .text-muted {
    color: #aaa !important;
}

/* Dark mode styles for user profile dropdown */
...
body.dark-mode .profile-header .profile-dropdown-overlay {
    background: linear-gradient(135deg, rgba(0,0,0,0.7), rgba(0,0,0,0.6)) !important;
}

body.dark-mode .profile-dropdown-content h6,
body.dark-mode .profile-dropdown-content .text-muted {
    text-shadow: 2px 2px 4px rgba(0,0,0,0.8) !important;
}

body.dark-mode .dropdown-user-profile .dropdown-item {
    color: #e0e0e0 !important;
}

body.dark-mode .dropdown-user-profile .dropdown-item:hover {
    background-color: #333 !important;
}

body.dark-mode .dropdown-user-profile .dropdown-divider {
    border-color: #444 !important;
}

/* Dark mode styles for pc-header */
...
body.dark-mode .pc-header .weather-widget,
body.dark-mode .pc-header .datetime-widget {
    color: #e0e0e0 !important;
}

body.dark-mode .pc-header .text-muted {
    color: #aaa !important;
}

body.dark-mode .pc-header .drp-search {
    background-color: #2d2d2d !important;
    border-color: #444 !important;
}

body.dark-mode .pc-header .drp-search input {
    background-color: #333 !important;
    color: #e0e0e0 !important;
    border-color: #555 !important;
}

body.dark-mode .pc-header .drp-search i {
    color: #888 !important;
}
  </style>
</head>
